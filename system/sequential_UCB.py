...
if __name__ == '__main__':
    ...
    gt_data = pd.read_csv(os.path.join(ppath, 'truth', dataset, f'{dataset}.multi_attrs.{utility_function}.csv'))
    gt_df = gt_data.copy()
    ...
    result_dst_dir = os.path.join(ppath, 'testresults', f"seq_UCB.{utility_function}.{semantic_metric}")
